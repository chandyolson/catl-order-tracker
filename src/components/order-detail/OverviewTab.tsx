  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {/* LEFT: Order Details */}
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <div className="px-4 py-3 flex items-center" style={{ backgroundColor: "#0E2646", borderRadius: "11px 11px 0 0", minHeight: 48 }}>
        ...
        {/* RIGHT: Task List */}
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <div className="px-4 py-3 flex items-center justify-between" style={{ backgroundColor: "#0E2646", borderRadius: "11px 11px 0 0", minHeight: 48 }}>
      ...
      {orderMemos.length > 0 && (
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <div className="px-4 py-3 flex items-center gap-2" style={{ backgroundColor: "#0E2646", borderRadius: "11px 11px 0 0", minHeight: 48 }}>
